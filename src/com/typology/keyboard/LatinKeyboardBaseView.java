...
public class LatinKeyboardBaseView extends View implements PointerTracker.UIProxy {
    ...
    public LatinKeyboardBaseView mMiniKeyboard;
    ...
    private boolean mPopupKeysShown = false;
    ...
    private void dismissPopupKeyboard() {
        if (mMiniKeyboardPopup.isShowing()) {
            ...
            invalidateAllKeys();
            updatePopupKeyboardState(false);
        }
    }
    
    public void updatePopupKeyboardState(boolean shown) {
    	mPopupKeysShown = shown;
    }
    
    public boolean popupKeyboardShown() {
    	return mPopupKeysShown;
    }
